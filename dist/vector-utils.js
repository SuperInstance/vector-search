 ...
 * ```
 */
export function batchCosineSimilarity(query, vectors, dimension) {
 ...
 * ```
 */
export function topKSimilar(query, vectors, dimension, k) {
 ...
 * ```
 */
export function vectorMean(vectors, dimension) {
    const numVectors = vectors.length / dimension;
 ...
 * ```
 */
export function weightedSum(vectors, weights, dimension) {
    const numVectors = vectors.length / dimension;
 ...
 * ```
 */
export function estimateMemorySize(numVectors, dimension) {
 ...
 * ```
 */
export function recommendedBatchSize(vectorDimension) {
